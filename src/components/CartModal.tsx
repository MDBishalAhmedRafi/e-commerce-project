        ...
        <>
          ...
          <div className="">
            ...
            <div className="flex justify-between text-sm">
              ...
              <button className="rounded-md py-3 px-3 bg-black text-white">
                Checkout
              </button>
            </div>
          </div>
